...
export class InvoicingComponent {
  ...
  listInf = [
    {
      title: 'Ultima vez que a automação foi executada.',
      value: '06/03/2023',
      color: 'blue',
    },
    {
      title: 'Você deveria ter executado.',
      value: '15/03/2023',
      color: 'yellow',
    },
    {
      title: 'Próxima data para gerar automação',
      value: '31/03/2023',
      color: 'green',
    },
    { title: 'O serviço está on.', value: '', color: 'green-light' },
